...
const Hero = (props: Props) => {
  return (
    <>
      <div className="min-h-[600px] md:h-[400px] relative bg-[rgba(45,47,123,0.8)] ">
        <div className="min-h-[600px] md:h-[400px] w-full absolute top-0 left-0 bottom-0 z-10">
          <Image src={plan} alt="" fill />
        </div>
        <div className="min-h-[600px] md:h-[400px] w-full bg-[rgba(0,0,0,0.7)] absolute top-0 left-0 bottom-0 z-20"></div>
