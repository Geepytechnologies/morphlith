...
const Hero = (props: Props) => {
  return (
    <>
      <div className="h-[600px] md:h-[400px] relative bg-[rgba(45,47,123,0.8)] ">
        <div className="h-[600px] md:h-[400px] w-full absolute top-0 left-0 bottom-0 z-10">
          <Image src={plan} alt="" fill />
        </div>
        <div className="h-[600px] md:h-[400px] w-full bg-[rgba(0,0,0,0.7)] absolute top-0 left-0 bottom-0 z-20"></div>
        <div className="h-[600px] md:h-[400px] w-full absolute top-0 left-0 bottom-0 z-20">
          <ParticleApp />
        </div>
        <div className="h-[600px] md:h-[400px] w-full absolute top-0 left-0 bottom-0 flex flex-col md:flex-row items-center gap-2 lg:gap-5 py-4 px-3 lg:p-4 z-30">
          ...
          <div className=" text-white w-full font-cab md:basis-[50%] flex items-center justify-center">
            <div className="relative w-full h-full flex justify-center">
              ...
              <div className="h-9 w-9 bg-[#52FF00] absolute left-9 bottom-[50px] corner">
                Innovate
              </div>
            </div>
          </div>
